...
import edu.cnm.deepdive.craps.comtroller.Controller;
...
public class Main extends Application {
  ...
  private static final String FXML_LOADER = "main.fxml";
  ...
  private void setupLoaders() {
    ...
    fxmlLoader = new FXMLLoader(classLoader.getResource(RESOURCE_PATH + FXML_LOADER), bundle);
  }
